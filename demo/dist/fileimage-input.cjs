...
// fileimage-input.ts
var fileimage_input_exports = {};
__export(fileimage_input_exports, {
  FileImageInputElement: () => FileImageInputElement
});
module.exports = __toCommonJS(fileimage_input_exports);
